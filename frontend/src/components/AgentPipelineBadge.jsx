...
import WebSearchInspectorModal from './WebSearchInspectorModal';
...
export default function AgentPipelineBadge({ agentTrace }) {
  ...
  return (
    <>
        ...
        <div className="flex flex-wrap items-center justify-between gap-2">
          <div className="flex flex-wrap items-center gap-1.5 text-[10px]">
            ...
            {webSearchPerformed && (
              <button
                ...
                className="inline-flex items-center gap-1 px-2 py-0.5 rounded-md bg-blue-500/15 text-blue-300 border border-blue-500/30 hover:bg-blue-500/25 transition-colors cursor-pointer"
                title="Apri console di ispezione fonti web"
              >
          ...
          <div className="flex items-center gap-1.5">
            <button
              type="button"
              onClick={() => setIsInspectorOpen(true)}
              className="text-[10px] text-blue-400 hover:text-blue-300 flex items-center gap-1 font-semibold py-0.5 px-2 rounded-lg bg-blue-950/40 border border-blue-500/30 hover:bg-blue-900/30 transition-all"
              title="Ispeziona fonti web & console multi-metodo"
            >
            ...
            >
              <span>{isOpen ? 'Nascondi' : 'Dettagli'}</span>
          ...
          <div className="mt-3 p-3.5 rounded-2xl bg-slate-950/90 border border-purple-500/25 space-y-3 text-xs animate-in fade-in slide-in-from-top-1 duration-200">
            ...
            <div className="space-y-1.5 pt-2 border-t border-slate-900">
              <div className="flex items-center justify-between text-[11px] font-bold text-blue-300">
                <span className="flex items-center gap-1.5">
                  ...
                  3. Verifica Web Multi-Metodo in Tempo Reale (Priorità 2)
                </span>
                <button
                  type="button"
                  onClick={() => setIsInspectorOpen(true)}
                ...
                >
                  <span>Apri Console Inspector ↗</span>
                </button>
              </div>
            ...
            <div className="pt-2 border-t border-slate-900 flex items-center justify-between text-[10px] text-slate-400">
              <span className="flex items-center gap-1.5 text-emerald-400 font-semibold">
                ...
                Sintesi completata: Fonti verificate e risposta certificata senza dubbio.
              </span>
      ...
      {/* Web Fact-Checking Inspector Modal */}
      {isInspectorOpen && (
